...
class MePageActivity : AppCompatActivity() {

    private lateinit var binding: ActivityMePageBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMePageBinding.inflate(layoutInflater)
        ...
        binding.deliveryAddressRow.setOnClickListener {
        ...
        binding.RewardRow.setOnClickListener {
